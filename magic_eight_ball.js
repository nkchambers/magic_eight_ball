//CODECADEMY JAVASCRIPT PRACTICE - Magic Eight Ball Project 
...
// Task 2 - Below this variable, create a ternary expression that decides what to do if the user enters a name or not. 
...
console.log(`Hello, ${userName}! The user asked: ${userQuestion}`);
...
// Task 6 - Create one more variable named eightBall, and set it equal to an empty string. 
// We will save a value to this variable in the next steps, depending on the value of randomNumber.
let eightBall = '';


// Task 7 - We need to create a control flow that takes in the randomNumber we made in step 5, 
